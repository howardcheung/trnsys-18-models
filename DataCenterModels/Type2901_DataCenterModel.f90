...
! Object: Data Center Rack Model
! Simulation Studio Model: Type2901_DataCenterModel
! 

! Author: Howard Cheung, Shengwei Wang
! Editor: 
! Date:	 July 11, 2017
...
! *** 
!			Idle power	W [0;+Inf]
!			Standby power	W [0;+Inf]
!			Coefficient of frequency for power	W [0;+Inf]
!			Number of racks	- [0;+Inf]
!			Number of cores	- [0;+Inf]
!			Maximum processor frequency	1/S [0;+Inf]
!			Minimum processor frequency	1/S [0;+Inf]
...
!DEC$Attributes DLLexport :: Type2901
...
!    PARAMETERS
      DOUBLE PRECISION Idle_power
      DOUBLE PRECISION Standby_power
      DOUBLE PRECISION Coefficient_of_frequency_for_power
      DOUBLE PRECISION Number_of_racks
      DOUBLE PRECISION Number_of_cores
      DOUBLE PRECISION Maximum_processor_frequency
      DOUBLE PRECISION Minimum_processor_frequency
...
!Do All of the First Timestep Manipulations Here - There Are No Iterations at the Intial Time
      ...
      Idle_power = getParameterValue(1)
      Standby_power = getParameterValue(2)
      Coefficient_of_frequency_for_power = getParameterValue(3)
      Number_of_racks = getParameterValue(4)
      Number_of_cores = getParameterValue(5)
      Maximum_processor_frequency = getParameterValue(6)
      Minimum_processor_frequency = getParameterValue(7)
